...
namespace PaintShopMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "{0} musi mieć co najmniej {2} znaków i max {1} długości.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "Wpisano różne hasła")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Potwierdź emial",
                        $"Potwierdź Twoje konto <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>Naciśnij</a>.");
